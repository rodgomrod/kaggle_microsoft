...
echo -e "\e[92m\e[5mSubmitting predictions \e[34m${model_name}\e[0m"
kaggle competitions submit -c microsoft-malware-prediction -f submissions/${model_name}.csv -m "Nuevos datos V4: con versiones - ${params} - k = ${k} Versions = ${drop_version} y ftsel: ${ftsel}"
echo ""
echo ""
echo ""
